<?php session_start()?>
<?php include './coffeeshopdestop-master/config/config.php'?>
<?php include './coffeeshopdestop-master/config/database.php'?>
<?php include './coffeeshopdestop-master/config/Helper.php'?>
...
<head>
    ...
    <link rel="icon" href="./coffeeshopdestop-master/assets/img/sliders/favicon.png" />
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <div class="logo">
                        <h1><a href="./"><img src="./coffeeshopdestop-master/assets/img/bht_bookstore_logo.png" style="height: 60px"></a></h1>
                    </div>
                </div>
